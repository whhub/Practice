...
{
    ReturnData add(MultipartFile file, String docName, String type, String classify, String label, String introduction, HttpServletRequest request);
    ReturnData fuzzyFind(String docName);
    ReturnData find(Integer id);
    ReturnData findAll();
