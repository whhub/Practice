...
public class AlgorithmModelServiceImpl implements AlgorithmModelService
{
    ...
    public ReturnData addModel(String json)
    {
        ...
        AlgorithmModel model=new AlgorithmModel(model1.getModelName(),model1.getVersion(),model1.getIsOpen(),Util.getCurrentDateAndTime(),model1.getMsg(),model1.getAuthor(),model1.getFurmula(),0);
